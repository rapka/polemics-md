...
On October 23, 2023, Sky News aired an [interview](https://twitter.com/SkyNews/status/1716176823862587814) with Israeli president Isaac Herzog in which he presented two documents. According to Herzog, these pages come from an official instruction manual written by al-Qaeda of how to produce chemical weapons recovered from Hamas. An accompanying [statement](https://www.gov.il/en/departments/news/president-herzog-interviewed-on-sky-news-22-oct-2023) released by the Prime Minister's office proclaims the following:
...
Shortly after the interview went up, Journalist [Séamus Malekafzali](https://twitter.com/Seamus_Malek/status/1716278455677923711) found a file containing the first page shown by Herzog on a book hosting website named [noor-book.com](https://www.noor-book.com/en/ebook-%D8%B1%D9%85%D8%B2%D9%8A-%D9%8A%D9%88%D8%B3%D9%81-pdf), but this is not the true origin of this document. The page on noor-book.com indicates that the file was taken from the Internet Archive and I was indeed able to find the [original PDF](https://archive.org/details/hamanyzaied_gmail_20140223/page/n3/mode/2up) there[^1]. The contents appear to pertain to [Ramzi Yousef](https://en.wikipedia.org/wiki/Ramzi_Yousef), ringleader of the 1993 World Trade Center bombings and the document doesn't include the other page shown by Herzog.
...
As he holds up this page, Herzog claims that Israel is "dealing with ISIS, al-Qaeda, Hamas". This is in line with the press release's allegation that the document represents an "attempt of the terrorist organization Hamas to trace back to ISIS". Similarly, Israel's Twitter/X account has outright stated ["Hamas is ISIS"](https://twitter.com/Israel/status/1713196336470790156) and created an accompanying #HamasISIS hashtag. While Israel's press release mentions the age of the instructions, Herzog doesn't mention that the chemical weapon plans are older than ISIS, giving the impression that Hamas may be actively collaborating with ISIS or al-Qaeda.
...
![Alleged Mubtakkar diagram with English translations](images/herzog-documents/diagram-translated.jpg)
...
The [about page](http://dickdestiny.com/blog1/?page_id=7603) for the updated Dick Destiny blog also reveals an incredible coincidence: George Smiths' first claim to fame was acting as an expert witness for the trial of the alleged [Wood Green ricin bioterrorist plot](https://en.wikipedia.org/wiki/Wood_Green_ricin_plot).

Some context: Back in January 2003, UK police arrested over a dozen people and charged them with plotting a major terrorist attack using the poison ricin (famously [portrayed](https://breakingbad.fandom.com/wiki/Problem_Dog) in Breaking Bad). After an investigation, it was revealed that no ricin was ever detected and all but one of the suspects were released or acquitted. However, the public was not informed that the poison scare was a false positive until 2005 and in early 2023 it was [revealed by lawyer involved with the case](https://bylinetimes.com/2023/03/30/ricin-and-the-red-tops-how-a-made-up-terror-plot-helped-the-media-build-the-case-for-the-iraq-war/) that the faulty intelligence that led to the arrests was probably obtained through torture.

Of course, none of this prevented Colin Powell from testifying to the United Nations that the network of terrorists he claimed had ties to Iraq and Saddam Hussein contained a "UK Poison Cell". Benjamin Netanyahu, who is somehow still the Prime Minister of Israel, [also participated in this hearing](https://www.youtube.com/watch?v=d_PDpwL8kuY). In his testimony, he warned of Saddam Hussein's (non-existent) ability to produce weapons of mass destruction without being detected and said that an American invasion of Iraq would be "the right choice". 

The United States would infamously go on to invade Iraq despite the lack of concrete evidence, ironically leading to the insurgency that would allow ISIS to establish itself in the country.

![Slide presented by Colin Powell to the UN showing "UK poison cell" with ties to Iraq](uk-poison-cell.jpg)
*(Slide presented by Colin Powell to the UN alleging a "UK poison cell" with ties to Iraq)*
...
[^3] wmdinsights.com now redirects to [SAIC](https://en.wikipedia.org/wiki/Science_Applications_International_Corporation), a major government contractor.
